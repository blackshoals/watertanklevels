...
float display_battery_percentage;
...
void drawData()
{
    lv_bar_set_value(ui_barUpper, upper_tank_percentage, LV_ANIM_OFF);
    lv_bar_set_value(ui_barLower, lower_tank_percentage, LV_ANIM_OFF);
